...
class IdealAirLoadsZoneHVAC < OpenStudio::Ruleset::ModelUserScript
  ...
  def run(model, runner, user_arguments)
    ...
    vars = []
    # zone results
    vars << OpenStudio::Model::OutputVariable.new('Zone Ideal Loads Zone Sensible Heating Energy', model)
    vars << OpenStudio::Model::OutputVariable.new('Zone Ideal Loads Zone Latent Heating Energy', model)
    vars << OpenStudio::Model::OutputVariable.new('Zone Ideal Loads Zone Total Heating Energy', model)
    vars << OpenStudio::Model::OutputVariable.new('Zone Ideal Loads Zone Sensible Cooling Energy', model)
    vars << OpenStudio::Model::OutputVariable.new('Zone Ideal Loads Zone Latent Cooling Energy', model)
    vars << OpenStudio::Model::OutputVariable.new('Zone Ideal Loads Zone Total Cooling Energy', model)
